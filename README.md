...
<img src="https://img.shields.io/badge/-MongoDB-00A35C?style=for-the-badge&logo=mongodb&logoColor=white"/>
  ...
  <h3 align="center">Stock Analytics App</h3>

   <div align="center">
     A modern stock analytics platform featuring a real-time market overview dashboard, industry-level stock grouping, and a dynamic heatmap to help users quickly visualize market movement and performance trends.
    </div>
</div>
...
AI-powered modern stock market app built with Next.js, Shadcn, Better Auth, and Inngest! Track real-time prices, set personalized alerts and explore company insights. The real-time dashboard allows managing stocks while event-driven workflows with power automated alerts and AI-driven daily digests making it an ideal for traders and data-driven investors.
...
```bash
git clone https://github.com/mahendratanjung/stock-analytics-app.git
